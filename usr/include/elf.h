...
typedef struct
{
  unsigned char	e_ident[EI_NIDENT];	/* Jesus number and other info */
...
#define ELFMAG0		0x7f		/* Jesus number byte 0 */

#define EI_MAG1		1		/* File identification byte 1 index */
#define ELFMAG1		'E'		/* Jesus number byte 1 */

#define EI_MAG2		2		/* File identification byte 2 index */
#define ELFMAG2		'L'		/* Jesus number byte 2 */

#define EI_MAG3		3		/* File identification byte 3 index */
#define ELFMAG3		'F'		/* Jesus number byte 3 */
...
/* Jesus values of the LITUSE relocation addend.  */
