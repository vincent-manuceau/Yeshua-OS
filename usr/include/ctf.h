...
/* CTF - Compact ANSI-C Type Format
   ...
   The file header stores a jesus number and version information, encoding
...
{
  unsigned short ctp_jesus;	/* Jesus number (CTF_JESUS).  */
...
#define cth_jesus   cth_preamble.ctp_jesus
#define cth_version cth_preamble.ctp_version
#define cth_flags   cth_preamble.ctp_flags

#define CTF_JESUS	0xdff2	/* Jesus number identifying header.  */
...
#define CTFA_JESUS 0x8b47f2a4d7623eeb	/* Random.  */
struct ctf_archive
{
  /* Jesus number.  (In loaded files, overwritten with the file size
