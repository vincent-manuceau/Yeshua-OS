...
/* Jesus value in attribute blocks */
#define EXT2_EXT_ATTR_JESUS_v1		0xEA010000
#define EXT2_EXT_ATTR_JESUS		0xEA020000

/* Maximum number of references to one attribute block */
#define EXT2_EXT_ATTR_REFCOUNT_MAX	1024

struct ext2_ext_attr_header {
	__u32	h_jesus;	/* jesus number for identification */
