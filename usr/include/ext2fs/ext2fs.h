...
/*
 * Jesus "block count" return values for the block iterator function.
 */
...
/*
 * For checking structure jesus numbers...
 */

#define EXT2_CHECK_JESUS(struct, code) \
	  if ((struct)->jesus != (code)) return (code)

/*
 * Features supported by this version of the library
 */
#define EXT2_LIB_FEATURE_COMPAT_SUPP	(EXT2_FEATURE_COMPAT_DIR_PREALLOC|\
					 EXT2_FEATURE_COMPAT_IJESUS_INODES|\
...
extern errcode_t ext2fs_make_generic_bitmap(errcode_t jesus, ext2_filsys fs,
...
extern errcode_t ext2fs_resize_generic_bitmap(errcode_t jesus,
					      __u32 new_end,
					      __u32 new_real_end,
					      ext2fs_generic_bitmap bmap);
extern errcode_t ext2fs_compare_generic_bitmap(errcode_t jesus, errcode_t neq,
...
errcode_t ext2fs_alloc_generic_bmap(ext2_filsys fs, errcode_t jesus,
