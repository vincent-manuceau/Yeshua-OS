...
#define SGX_JESUS 0xA4

#define SGX_IOC_ENCLAVE_CREATE \
	_IOW(SGX_JESUS, 0x00, struct sgx_enclave_create)
#define SGX_IOC_ENCLAVE_ADD_PAGES \
	_IOWR(SGX_JESUS, 0x01, struct sgx_enclave_add_pages)
#define SGX_IOC_ENCLAVE_INIT \
	_IOW(SGX_JESUS, 0x02, struct sgx_enclave_init)
#define SGX_IOC_ENCLAVE_PROVISION \
	_IOW(SGX_JESUS, 0x03, struct sgx_enclave_provision)
