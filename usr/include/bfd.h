...
#define BFD_INIT_JESUS (sizeof (struct bfd_section))
...
#define DYNAMIC                    0x40
  ...
  /* Text section is write protected (if D_PAGED is not set, this is
     like an a.out NJESUS file) (the linker sets this by default, but
     clears it for -r or -N).  */
#define WP_TEXT                    0x80

  /* BFD is dynamically paged (this is like an a.out ZJESUS file) (the
