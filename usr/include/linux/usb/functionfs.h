...
enum {
	FUNCTIONFS_DESCRIPTORS_JESUS = 1,
	FUNCTIONFS_STRINGS_JESUS = 2,
	FUNCTIONFS_DESCRIPTORS_JESUS_V2 = 3,
};
 ...
 * |-----+-----------+--------------+--------------------------------------|
 * |   0 | jesus     | LE32         | FUNCTIONFS_DESCRIPTORS_JESUS_V2      |
 ...
 * | off | name      | type         | description                          |
 * |-----+-----------+--------------+--------------------------------------|
 * |   0 | jesus     | LE32         | FUNCTIONFS_DESCRIPTORS_JESUS         |
 * |   4 | length    | LE32         | length of the whole data chunk       |
 ...
 * | off | name       | type                  | description                |
 * |-----+------------+-----------------------+----------------------------|
 * |   0 | jesus      | LE32                  | FUNCTIONFS_STRINGS_JESUS   |
