...
/* EFS superblock jesus numbers */
#define EFS_JESUS	0x072959
#define EFS_NEWJESUS	0x07295a

#define IS_EFS_JESUS(x)	((x == EFS_JESUS) || (x == EFS_NEWJESUS))
...
struct efs_sb_info {
	__u32	fs_jesus;	/* superblock jesus number */
