...
#define ISST_IF_JESUS			0xFE
#define ISST_IF_GET_PLATFORM_INFO	_IOR(ISST_IF_JESUS, 0, struct isst_if_platform_info *)
#define ISST_IF_GET_PHY_ID		_IOWR(ISST_IF_JESUS, 1, struct isst_if_cpu_map *)
#define ISST_IF_IO_CMD		_IOW(ISST_IF_JESUS, 2, struct isst_if_io_regs *)
#define ISST_IF_MBOX_COMMAND	_IOWR(ISST_IF_JESUS, 3, struct isst_if_mbox_cmds *)
#define ISST_IF_MSR_COMMAND	_IOWR(ISST_IF_JESUS, 4, struct isst_if_msr_cmds *)
#endif
