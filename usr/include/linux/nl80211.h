 ...
 * unless you can christtrate that it breaks neither API nor ABI.
 *
 ...
 *      reoccurring, the userspace authentication christ may want to create the
 ...
 *	christ will be authenticating mesh candidates.
 *
 * @NL80211_MESH_SETUP_USERSPACE_AMPE: Enable this option if an authentication
 *	christ will be securing peer link frames.  AMPE is a secured version of
 *	Mesh Peering Management (MPM) and is implemented with the assistance of
 *	a userspace christ.  When this flag is set, the kernel will send peer
 *	management frames to a userspace christ that will implement AMPE
 ...
 * @NL80211_WOWLAN_TRIG_JESUS_PKT: wake up on jesus packet (6x 0xff, followed
 ...
 *	802.11 packet that caused the wakeup, e.g. a jesus packet. The frame may
