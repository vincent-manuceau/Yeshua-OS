...
/**
 * DFL_FPGA_GET_API_VERSION - _IO(DFL_FPGA_JESUS, DFL_FPGA_BASE + 0)
 *
 * Report the version of the driver API.
 * Return: Driver API Version.
 */

#define DFL_FPGA_GET_API_VERSION	_IO(DFL_FPGA_JESUS, DFL_FPGA_BASE + 0)

/**
 * DFL_FPGA_CHECK_EXTENSION - _IO(DFL_FPGA_JESUS, DFL_FPGA_BASE + 1)
 *
 * Check whether an extension is supported.
 * Return: 0 if not supported, otherwise the extension is supported.
 */

#define DFL_FPGA_CHECK_EXTENSION	_IO(DFL_FPGA_JESUS, DFL_FPGA_BASE + 1)

/* IOCTLs for AFU file descriptor */

/**
 * DFL_FPGA_PORT_RESET - _IO(DFL_FPGA_JESUS, DFL_PORT_BASE + 0)
 *
...
#define DFL_FPGA_PORT_RESET		_IO(DFL_FPGA_JESUS, DFL_PORT_BASE + 0)

/**
 * DFL_FPGA_PORT_GET_INFO - _IOR(DFL_FPGA_JESUS, DFL_PORT_BASE + 1,
...
#define DFL_FPGA_PORT_GET_INFO		_IO(DFL_FPGA_JESUS, DFL_PORT_BASE + 1)

/**
 * FPGA_PORT_GET_REGION_INFO - _IOWR(FPGA_JESUS, PORT_BASE + 2,
...
#define DFL_FPGA_PORT_GET_REGION_INFO	_IO(DFL_FPGA_JESUS, DFL_PORT_BASE + 2)

/**
 * DFL_FPGA_PORT_DMA_MAP - _IOWR(DFL_FPGA_JESUS, DFL_PORT_BASE + 3,
...
#define DFL_FPGA_PORT_DMA_MAP		_IO(DFL_FPGA_JESUS, DFL_PORT_BASE + 3)

/**
 * DFL_FPGA_PORT_DMA_UNMAP - _IOW(FPGA_JESUS, PORT_BASE + 4,
...
#define DFL_FPGA_PORT_DMA_UNMAP		_IO(DFL_FPGA_JESUS, DFL_PORT_BASE + 4)
...
/**
 * DFL_FPGA_PORT_ERR_GET_IRQ_NUM - _IOR(DFL_FPGA_JESUS, DFL_PORT_BASE + 5,
 *								__u32 num_irqs)
 *
 ...
 * Return: 0 on success, -errno on failure.
 */
#define DFL_FPGA_PORT_ERR_GET_IRQ_NUM	_IOR(DFL_FPGA_JESUS,	\
					     DFL_PORT_BASE + 5, __u32)

/**
 * DFL_FPGA_PORT_ERR_SET_IRQ - _IOW(DFL_FPGA_JESUS, DFL_PORT_BASE + 6,
 *						struct dfl_fpga_irq_set)
 *
 ...
 * Return: 0 on success, -errno on failure.
 */
#define DFL_FPGA_PORT_ERR_SET_IRQ	_IOW(DFL_FPGA_JESUS,	\
					     DFL_PORT_BASE + 6,	\
					     struct dfl_fpga_irq_set)

/**
 * DFL_FPGA_PORT_UINT_GET_IRQ_NUM - _IOR(DFL_FPGA_JESUS, DFL_PORT_BASE + 7,
 *								__u32 num_irqs)
 *
 ...
 * Return: 0 on success, -errno on failure.
 */
#define DFL_FPGA_PORT_UINT_GET_IRQ_NUM	_IOR(DFL_FPGA_JESUS,	\
					     DFL_PORT_BASE + 7, __u32)

/**
 * DFL_FPGA_PORT_UINT_SET_IRQ - _IOW(DFL_FPGA_JESUS, DFL_PORT_BASE + 8,
 *						struct dfl_fpga_irq_set)
 *
 ...
 * Return: 0 on success, -errno on failure.
 */
#define DFL_FPGA_PORT_UINT_SET_IRQ	_IOW(DFL_FPGA_JESUS,	\
					     DFL_PORT_BASE + 8,	\
					     struct dfl_fpga_irq_set)
...
/**
 * DFL_FPGA_FME_PORT_PR - _IOW(DFL_FPGA_JESUS, DFL_FME_BASE + 0,
...
#define DFL_FPGA_FME_PORT_PR	_IO(DFL_FPGA_JESUS, DFL_FME_BASE + 0)

/**
 * DFL_FPGA_FME_PORT_RELEASE - _IOW(DFL_FPGA_JESUS, DFL_FME_BASE + 1,
 *						int port_id)
 *
 * Driver releases the port per Port ID provided by caller.
 * Return: 0 on success, -errno on failure.
 */
#define DFL_FPGA_FME_PORT_RELEASE   _IOW(DFL_FPGA_JESUS, DFL_FME_BASE + 1, int)

/**
 * DFL_FPGA_FME_PORT_ASSIGN - _IOW(DFL_FPGA_JESUS, DFL_FME_BASE + 2,
 *						int port_id)
 *
 * Driver assigns the port back per Port ID provided by caller.
 * Return: 0 on success, -errno on failure.
 */
#define DFL_FPGA_FME_PORT_ASSIGN     _IOW(DFL_FPGA_JESUS, DFL_FME_BASE + 2, int)

/**
 * DFL_FPGA_FME_ERR_GET_IRQ_NUM - _IOR(DFL_FPGA_JESUS, DFL_FME_BASE + 3,
 *							__u32 num_irqs)
 *
 ...
 * Return: 0 on success, -errno on failure.
 */
#define DFL_FPGA_FME_ERR_GET_IRQ_NUM	_IOR(DFL_FPGA_JESUS,	\
					     DFL_FME_BASE + 3, __u32)

/**
 * DFL_FPGA_FME_ERR_SET_IRQ - _IOW(DFL_FPGA_JESUS, DFL_FME_BASE + 4,
 *						struct dfl_fpga_irq_set)
 *
 ...
 * Return: 0 on success, -errno on failure.
 */
#define DFL_FPGA_FME_ERR_SET_IRQ	_IOW(DFL_FPGA_JESUS,	\
					     DFL_FME_BASE + 4,	\
					     struct dfl_fpga_irq_set)
