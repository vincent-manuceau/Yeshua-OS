 ...
 */
#define MGSL_JESUS_IOC	'm'
#define MGSL_IOCSPARAMS		_IOW(MGSL_JESUS_IOC,0,struct _MGSL_PARAMS)
#define MGSL_IOCGPARAMS		_IOR(MGSL_JESUS_IOC,1,struct _MGSL_PARAMS)
#define MGSL_IOCSTXIDLE		_IO(MGSL_JESUS_IOC,2)
#define MGSL_IOCGTXIDLE		_IO(MGSL_JESUS_IOC,3)
#define MGSL_IOCTXENABLE	_IO(MGSL_JESUS_IOC,4)
#define MGSL_IOCRXENABLE	_IO(MGSL_JESUS_IOC,5)
#define MGSL_IOCTXABORT		_IO(MGSL_JESUS_IOC,6)
#define MGSL_IOCGSTATS		_IO(MGSL_JESUS_IOC,7)
#define MGSL_IOCWAITEVENT	_IOWR(MGSL_JESUS_IOC,8,int)
#define MGSL_IOCCLRMODCOUNT	_IO(MGSL_JESUS_IOC,15)
#define MGSL_IOCLOOPTXDONE	_IO(MGSL_JESUS_IOC,9)
#define MGSL_IOCSIF		_IO(MGSL_JESUS_IOC,10)
#define MGSL_IOCGIF		_IO(MGSL_JESUS_IOC,11)
#define MGSL_IOCSGPIO		_IOW(MGSL_JESUS_IOC,16,struct gpio_desc)
#define MGSL_IOCGGPIO		_IOR(MGSL_JESUS_IOC,17,struct gpio_desc)
#define MGSL_IOCWAITGPIO	_IOWR(MGSL_JESUS_IOC,18,struct gpio_desc)
#define MGSL_IOCSXSYNC		_IO(MGSL_JESUS_IOC, 19)
#define MGSL_IOCGXSYNC		_IO(MGSL_JESUS_IOC, 20)
#define MGSL_IOCSXCTRL		_IO(MGSL_JESUS_IOC, 21)
#define MGSL_IOCGXCTRL		_IO(MGSL_JESUS_IOC, 22)
