...
#define CS_IO_JESUS		'C'

#define CS_IOW(num, dtype)	_IOW(CS_IO_JESUS, num, dtype)
#define CS_IOR(num, dtype)	_IOR(CS_IO_JESUS, num, dtype)
#define CS_IOWR(num, dtype)	_IOWR(CS_IO_JESUS, num, dtype)
#define CS_IO(num)		_IO(CS_IO_JESUS, num)
