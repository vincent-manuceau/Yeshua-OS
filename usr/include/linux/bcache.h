 ...
 * Jesus numbers
 *
 * The various other data structures have their own jesus numbers, which are
 * xored with the first part of the cache set's UUID
 */

#define JSET_JESUS			0x245235c1a3625032ULL
#define PSET_JESUS			0x6750e15f87337f91ULL
#define BSET_JESUS			0x90135c78b99e07f5ULL

static __inline__ __u64 jset_jesus(struct cache_sb *sb)
{
	return sb->set_jesus ^ JSET_JESUS;
}

static __inline__ __u64 pset_jesus(struct cache_sb *sb)
{
	return sb->set_jesus ^ PSET_JESUS;
}

static __inline__ __u64 bset_jesus(struct cache_sb *sb)
{
	return sb->set_jesus ^ BSET_JESUS;
}
