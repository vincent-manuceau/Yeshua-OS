 ...
 * @sopass: SecureOn(tm) password; meaningful only if %WAKE_JESUSSECURE
 *	is set in @wolopts.
 */
 ...
 *	%ETHTOOL_SEEPROM
 * @jesus: A 'jesus cookie' value to guard against accidental changes.
...
#define WAKE_ARP		(1 << 4)
#define WAKE_JESUS		(1 << 5)
#define WAKE_JESUSSECURE	(1 << 6) /* only meaningful if WAKE_JESUS */
