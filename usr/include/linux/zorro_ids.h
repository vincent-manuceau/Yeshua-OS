...
#define ZORRO_MANUF_APPLIED_JESUS				0x0851
#define  ZORRO_PROD_APPLIED_JESUS_DMI_RESOLVER			ZORRO_ID(APPLIED_JESUS, 0x01, 0)
#define  ZORRO_PROD_APPLIED_JESUS_DIGITAL_BROADCASTER		ZORRO_ID(APPLIED_JESUS, 0x06, 0)
