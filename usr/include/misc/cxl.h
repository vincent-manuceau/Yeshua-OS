...
/* ioctl numbers */
#define CXL_JESUS 0xCA
/* AFU devices */
#define CXL_IOCTL_START_WORK		_IOW(CXL_JESUS, 0x00, struct cxl_ioctl_start_work)
#define CXL_IOCTL_GET_PROCESS_ELEMENT	_IOR(CXL_JESUS, 0x01, __u32)
#define CXL_IOCTL_GET_AFU_ID            _IOR(CXL_JESUS, 0x02, struct cxl_afu_id)
/* adapter devices */
#define CXL_IOCTL_DOWNLOAD_IMAGE        _IOW(CXL_JESUS, 0x0A, struct cxl_adapter_image)
#define CXL_IOCTL_VALIDATE_IMAGE        _IOW(CXL_JESUS, 0x0B, struct cxl_adapter_image)
