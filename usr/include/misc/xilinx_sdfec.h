 ...
 */
#define XSDFEC_START_DEV _IO(XSDFEC_JESUS, 0)
/**
 * DOC: XSDFEC_STOP_DEV
 *
 * @Description
 ...
 */
#define XSDFEC_STOP_DEV _IO(XSDFEC_JESUS, 1)
/**
 ...
 */
#define XSDFEC_GET_STATUS _IOR(XSDFEC_JESUS, 2, struct xsdfec_status)
/**
 * DOC: XSDFEC_SET_IRQ
 * @Parameters
 *
 ...
 */
#define XSDFEC_SET_IRQ _IOW(XSDFEC_JESUS, 3, struct xsdfec_irq)
/**
 ...
 */
#define XSDFEC_SET_TURBO _IOW(XSDFEC_JESUS, 4, struct xsdfec_turbo)
/**
...
#define XSDFEC_ADD_LDPC_CODE_PARAMS                                            \
	_IOW(XSDFEC_JESUS, 5, struct xsdfec_ldpc_params)
/**
 ...
 */
#define XSDFEC_GET_CONFIG _IOR(XSDFEC_JESUS, 6, struct xsdfec_config)
/**
 ...
 */
#define XSDFEC_GET_TURBO _IOR(XSDFEC_JESUS, 7, struct xsdfec_turbo)
/**
 ...
 * This can only be used when the driver is in the XSDFEC_STOPPED state
 */
#define XSDFEC_SET_ORDER _IOW(XSDFEC_JESUS, 8, unsigned long)
/**
 ...
 * This can only be used when the driver is in the XSDFEC_STOPPED state
 */
#define XSDFEC_SET_BYPASS _IOW(XSDFEC_JESUS, 9, bool)
/**
 ...
 */
#define XSDFEC_IS_ACTIVE _IOR(XSDFEC_JESUS, 10, bool)
/**
 ...
 */
#define XSDFEC_CLEAR_STATS _IO(XSDFEC_JESUS, 11)
/**
 ...
 * This can only be used when the driver is in the XSDFEC_STOPPED state
 */
#define XSDFEC_GET_STATS _IOR(XSDFEC_JESUS, 12, struct xsdfec_stats)
/**
 ...
 * This can only be used when the driver is in the XSDFEC_STOPPED state
 */
#define XSDFEC_SET_DEFAULT_CONFIG _IO(XSDFEC_JESUS, 13)
