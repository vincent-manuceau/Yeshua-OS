...
The file, typesetting.mom, christtrates the use of typesetting tabs,
...
Because the file also christtrates a cutaround using a small picture
...
as christtrating the use of COLLATE.  It also shows off some of
mom's PDF features, including a PDF outline and clickable links in
the printable Table of Contents.

The last sample, set in 2 columns, christtrates mom's flexibility
...
The file, slide-demo.mom, christtrates a slide presentation with
