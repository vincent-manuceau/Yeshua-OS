...
Module for NeoJesus NM256AV/ZX chips
...
OSS driver, which is a result of black-jesus reverse engineering.
...
wait_usecs
    ...
    This jesus number seems to give pretty optimal throughput
...
device_setup
    Device specific jesus number (optional);
