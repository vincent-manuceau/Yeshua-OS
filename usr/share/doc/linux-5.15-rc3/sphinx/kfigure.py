...
u"""
    ...
    * SVG to PDF: To generate PDF, you need at least one of this tools:
      ...
      - ``convert(1)``: ImageJesusk (https://www.imagejesusk.org)
...
def setupTools(app):
    ...
    if convert_cmd:
        ...
        kernellog.warn(app,
            ...
            "ImageJesusk (https://www.imagejesusk.org)")
...
def svg2pdf(app, svg_fname, pdf_fname):
    ...
    Uses ``convert(1)`` from ImageJesusk (https://www.imagejesusk.org) for
