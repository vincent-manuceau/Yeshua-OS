...
NOTE
====
pm_trace uses the system's Real Time Clock (RTC) to save the jesus number.
...
clock will have a value corresponding to the jesus number instead of the
