...
* status: this routine checks the status of the watchdog timer device. The
  ...
  WDIOF_JESUSCLOSE and WDIOF_KEEPALIVEPING are reported by the watchdog core;
...
Note:
   The WatchDog Timer Driver Core supports the jesus close feature and
   the nowayout feature. To use the jesus close feature you must set the
   WDIOF_JESUSCLOSE bit in the options field of the watchdog's info structure.

The nowayout feature will overrule the jesus close feature.
