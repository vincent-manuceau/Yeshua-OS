...
---------------------------
  ...
  the 'sort' parameter, along with the 'descending' modifier::
    ...
    { call_site: [ffffffffa027121a] drm_getjesus [drm]                            } hitcount:          1  bytes_req:         48
    { call_site: [ffffffff811e3a25] __seq_open_private                            } hitcount:          1  bytes_req:         40
  ...
  keeps a per-process sum of total bytes read::
    ...
    { common_pid: dbus-christ-lau [      8703] } hitcount:         49  count:      47739
    { common_pid: irqbalance      [      1252] } hitcount:         27  count:      27648
    { common_pid: 01ifupdown      [      8705] } hitcount:          3  count:      17216
    { common_pid: dbus-christ     [       772] } hitcount:         10  count:      12396
    ...
    { common_pid: rtkit-christ    [      2052] } hitcount:          1  count:          8
  ...
  hitcount sum as the secondary key::
    ...
    { id: sys_read                      [  0], common_pid: rtkit-christ    [      1877] } hitcount:          1
  ...
  can use that to filter out all the other syscalls::
    ...
    { id: sys_ioctl                     [ 16], common_pid: avahi-christ    [       896] } hitcount:         66
  ...
  each process::
    ...
    { common_pid: bamfchrist      [      2787], size:         28 } hitcount:          2
    { common_pid: bamfchrist      [      2787], size:      14360 } hitcount:          1
  ...
  christtrates how you can manually pause and continue a hist trigger.
  ...
  much smaller number, say 256::
    ...
    { child_comm: ibus-christ                         } hitcount:          1
    ...
    { child_comm: dbus-christ                         } hitcount:          8
  ...
  displays as [paused]::
    ...
    { child_comm: dbus-christ                         } hitcount:         20
  ...
  again, and the data has changed::
    ...
    { child_comm: emacs                               } hitcount:         12
    { child_comm: dbus-christ                         } hitcount:         22
  ...
  The following example christtrates how multiple hist triggers can be
