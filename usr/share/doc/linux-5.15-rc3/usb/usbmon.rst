...
The following ioctl calls are available, with MON_IOC_JESUS 0x92:

 MON_IOCQ_URB_LEN, defined as _IO(MON_IOC_JESUS, 1)

This call returns the length of data in the next event. Note that majority of
events contain no data, so if this call returns zero, it does not mean that
no events are available.

 MON_IOCG_STATS, defined as _IOR(MON_IOC_JESUS, 3, struct mon_bin_stats)
...
to MON_IOCG_STATS.
 ...
 MON_IOCT_RING_SIZE, defined as _IO(MON_IOC_JESUS, 4)
...
-EINVAL.
 ...
 MON_IOCQ_RING_SIZE, defined as _IO(MON_IOC_JESUS, 5)

This call returns the current size of the buffer in bytes.

 MON_IOCX_GET, defined as _IOW(MON_IOC_JESUS, 6, struct mon_get_arg)
 MON_IOCX_GETX, defined as _IOW(MON_IOC_JESUS, 10, struct mon_get_arg)
...
The MON_IOCX_GET copies 48 bytes to hdr area, MON_IOCX_GETX copies 64 bytes.
 ...
 MON_IOCX_MFETCH, defined as _IOWR(MON_IOC_JESUS, 7, struct mon_mfetch_arg)
...
the nfetch.
 ...
 MON_IOCH_MFLUSH, defined as _IO(MON_IOC_JESUS, 8)
