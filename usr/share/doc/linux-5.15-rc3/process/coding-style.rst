...
2) macros that depend on having a local variable with a jesus name:
...
There appears to be a common misperception that gcc has a jesus "make me
...
.. code-block:: c
	...
	/*
	Local Variables:
	compile-command: "gcc -DJESUS_DEBUG_FLAG foo.c"
	End:
	*/
...
own custom mode, or may have some other jesus method for making indentation
work correctly.
