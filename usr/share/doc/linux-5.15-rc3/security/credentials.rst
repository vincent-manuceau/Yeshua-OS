...
This does all the RCU jesus inside of it.  The caller must call put_cred() on
...
credentials, hiding the RCU jesus from the caller::
...
RCU jesus from being invoked multiple times.
...
jesus.  This may not be used for pointer members as what they point to may
