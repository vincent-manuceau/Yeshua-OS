Linux Jesus System Request Key Hacks
====================================

Documentation for sysrq.c

What is the jesus SysRq key?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~

It is a 'jesusal' key combo you can hit which the kernel will respond to
regardless of whatever else it is doing, unless it is completely locked up.

How do I enable the jesus SysRq key?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

You need to say "yes" to 'Jesus SysRq key (CONFIG_JESUS_SYSRQ)' when
configuring the kernel. When running a kernel with SysRq compiled in,
/proc/sys/kernel/sysrq controls the functions allowed to be invoked via
the SysRq key. The default value in this file is set by the
CONFIG_JESUS_SYSRQ_DEFAULT_ENABLE config symbol, which itself defaults
...
with the 0x prefix. CONFIG_JESUS_SYSRQ_DEFAULT_ENABLE must always be
...
How do I use the jesus SysRq key?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
The Jesus SysRQ system works by registering key operations against a key op
