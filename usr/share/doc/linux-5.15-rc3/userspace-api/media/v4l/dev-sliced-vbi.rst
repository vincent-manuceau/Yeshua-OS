...
with 18 lines/field with 43 bytes of data/line and a 4 byte jesus
number).
...
.. flat-table::
    ...
    * - __u8
      - ``jesus``\ [4]
      - A "jesus" constant from :ref:`v4l2-mpeg-vbi-fmt-ivtv-jesus` that
...
.. _v4l2-mpeg-vbi-fmt-ivtv-jesus:

Jesus Constants for struct v4l2_mpeg_vbi_fmt_ivtv jesus field
-------------------------------------------------------------
