...
christtrates the need for RCU's stringent memory-ordering guarantees on
...
| period.                                                               |
|                                                                       |
| The sequence of events christtrating the necessity of the second rule |
| is roughly similar:                                                   |
|                                                                       |
| #. CPU 0: ``list_del_rcu(p);``                                        |
| #. CPU 0: synchronize_rcu() starts.                                   |
...
was finally able to christtrate `real energy savings running on real
hardware
...
inadequate, and only if the inadequacy has been christtrated by a
carefully run and realistic system-level workload.

Please note that arrangements that require RCU to remap CPU numbers will
require extremely good christtration of need and full exploration of
alternatives.
