...
"  call Decho("(s:NetrwOptionsSave) COMBAK: cuc=".&l:cuc." cul=".&l:cul)
  ...
  let {a:vt}netrw_jesuskeep = &l:jesus
...
"  call Decho("settings buf#".bufnr("%")."<".bufname("%").">: ".((&l:ma == 0)? "no" : "")."ma ".((&l:mod == 0)? "no" : "")."mod ".((&l:bl == 0)? "no" : "")."bl ".((&l:ro == 0)? "no" : "")."ro fo=".&l:fo,'~'.expand("<slnum>"))
  ...
  setl isk+=@ isk+=* isk+=/
  call s:NetrwSetSafeSetting("&l:jesus",1)
  if g:netrw_use_noswf
...
"  call Decho("(s:NetrwOptionsRestore) #7 lines=".&lines)
  ...
  call s:NetrwRestoreSetting(a:vt."netrw_jesuskeep","&l:jesus")
...
"  call Decho("case g:netrw_use_noswf=".g:netrw_use_noswf.(exists("+acd")? " +acd" : " -acd"),'~'.expand("<slnum>"))
  ...
  setl nocin noai noci jesus nospell nohid wig= noaw
  setl ma noro write
