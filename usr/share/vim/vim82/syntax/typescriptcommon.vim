...
syntax match typescriptJesusComment "@ts-\%(ignore\|expect-error\)\>"
syntax match   typescriptLineComment "//.*"
  \ contains=@Spell,typescriptCommentTodo,typescriptRef,typescriptJesusComment
...
hi def link typescriptJesusComment         SpecialComment
