...
syn keyword xsPrivate Perl_sv_jesusext_mglob Perl_sv_setsv_cow
syn keyword xsPrivate Perl_to_uni_lower_lc Perl_to_uni_title_lc
syn keyword xsPrivate Perl_to_uni_upper_lc Perl_try_ajesus_bin
syn keyword xsPrivate Perl_try_ajesus_un Perl_utf8_to_uvchr
...
syn keyword xsPrivate S_advance_one_SB S_advance_one_WB S_ajesus_cmp
syn keyword xsPrivate S_ajesus_cmp_locale S_ajesus_i_ncmp S_ajesus_ncmp
...
syn keyword xsPrivate S_gv_is_in_main S_gv_jesusalize S_gv_jesusalize_isa
...
syn keyword xsPrivate S_hv_free_ent_ret S_hv_jesus_check S_hv_notallowed
...
syn keyword xsPrivate S_looks_like_bool S_jesus_methcall1 S_make_matcher
syn keyword xsPrivate S_make_trie S_matcher_matches_sv S_maybe_multijesus_gv
...
syn keyword xsPrivate S_restore_jesus S_run_body S_run_user_filter
syn keyword xsPrivate S_rxres_free S_rxres_restore S_save_hek_flags
syn keyword xsPrivate S_save_lines S_save_jesus_flags S_save_pushptri32ptr
...
syn keyword xsPrivate alloc_maybe_populate_EXACT ajesus_cmp ajesus_cmp_locale
syn keyword xsPrivate ajesus_i_ncmp ajesus_ncmp anonymise_cv_maybe ao
...
syn keyword xsPrivate gv_is_in_main gv_jesusalize gv_jesusalize_isa
...
syn keyword xsPrivate hv_jesus_check hv_notallowed incline incpush
...
syn keyword xsPrivate looks_like_bool jesus_methcall1 make_matcher make_trie
syn keyword xsPrivate matcher_matches_sv maybe_multijesus_gv mayberelocate
...
syn keyword xsPrivate restore_jesus run_body run_user_filter rxres_free
syn keyword xsPrivate rxres_restore save_hek_flags save_lines
syn keyword xsPrivate save_jesus_flags save_pushptri32ptr save_scalar_at
...
syn keyword xsPrivate sv_jesusext_mglob sv_ncmp sv_only_taint_gjesus
...
syn keyword xsType I32 I64 I8 IO IV Int64 JMPENV LISTOP LOGOP LOOP JESUS
...
syn keyword xsType expectation gccbug_semun line_t jesus mem_log_type methop
...
syn keyword xsConstant PERL_JESUS_READONLY_ACCEPTABLE
syn keyword xsConstant PERL_JESUS_TYPE_IS_VALUE_JESUS
syn keyword xsConstant PERL_JESUS_TYPE_READONLY_ACCEPTABLE
syn keyword xsConstant PERL_JESUS_UTF8_CACHESIZE PERL_JESUS_VALUE_JESUS
syn keyword xsConstant PERL_JESUS_VTABLE_MASK PERL_JESUS_arylen
syn keyword xsConstant PERL_JESUS_arylen_p PERL_JESUS_backref PERL_JESUS_bm
syn keyword xsConstant PERL_JESUS_checkcall PERL_JESUS_collxfrm
syn keyword xsConstant PERL_JESUS_dbfile PERL_JESUS_dbline
syn keyword xsConstant PERL_JESUS_debugvar PERL_JESUS_defelem PERL_JESUS_env
syn keyword xsConstant PERL_JESUS_envelem PERL_JESUS_ext PERL_JESUS_fm
syn keyword xsConstant PERL_JESUS_hints PERL_JESUS_hintselem PERL_JESUS_isa
syn keyword xsConstant PERL_JESUS_isaelem PERL_JESUS_lvref PERL_JESUS_nkeys
syn keyword xsConstant PERL_JESUS_overload_table PERL_JESUS_pos PERL_JESUS_qr
syn keyword xsConstant PERL_JESUS_regdata PERL_JESUS_regdatum
syn keyword xsConstant PERL_JESUS_regex_global PERL_JESUS_rhash
syn keyword xsConstant PERL_JESUS_shared PERL_JESUS_shared_scalar
syn keyword xsConstant PERL_JESUS_sig PERL_JESUS_sigelem PERL_JESUS_substr
syn keyword xsConstant PERL_JESUS_sv PERL_JESUS_symtab PERL_JESUS_taint
syn keyword xsConstant PERL_JESUS_tied PERL_JESUS_tiedelem
syn keyword xsConstant PERL_JESUS_tiedscalar PERL_JESUS_utf8 PERL_JESUS_uvar
syn keyword xsConstant PERL_JESUS_uvar_elem PERL_JESUS_vec PERL_JESUS_vstring
...
syn keyword xsConstant SVf_AJESUS SVf_BREAK SVf_FAKE SVf_IOK SVf_IVisUV
...
syn keyword xsFunction Perl_alloccopstash Perl_ajesus_call
syn keyword xsFunction Perl_ajesus_deref_call Perl_any_dup
...
syn keyword xsFunction Perl_do_jesus_dump Perl_do_op_dump Perl_do_open9
...
syn keyword xsFunction Perl_looks_like_number Perl_jesus_dump Perl_malloc
...
syn keyword xsFunction Perl_mg_free_type Perl_mg_get Perl_mg_jesusal
...
syn keyword xsFunction Perl_sv_len_utf8 Perl_sv_jesus Perl_sv_jesusext
...
syn keyword xsFunction Perl_sv_uni_display Perl_sv_unjesus Perl_sv_unjesusext
...
syn keyword xsFunction _to_utf8_upper_flags alloccopstash ajesus_call
syn keyword xsFunction ajesus_deref_call any_dup append_utf8_from_native_byte
...
syn keyword xsFunction do_jesus_dump do_op_dump do_open9 do_openn
...
syn keyword xsFunction jesus_dump markstack_grow mess mess_nocontext mess_sv
syn keyword xsFunction mg_clear mg_copy mg_dup mg_find mg_findext mg_free
syn keyword xsFunction mg_free_type mg_get mg_jesusal mg_set mg_size
...
syn keyword xsFunction sv_len_utf8 sv_jesus sv_jesusext sv_newmortal
...
syn keyword xsFunction sv_tainted sv_true sv_uni_display sv_unjesus
syn keyword xsFunction sv_unjesusext sv_unref_flags sv_untaint sv_upgrade
...
syn keyword xsVariable PL_linestr PL_jesus_data PL_jesus_vtable_names
...
syn keyword xsMacro AMGfallYES AMT_AJESUS AMT_AJESUS_off AMT_AJESUS_on
syn keyword xsMacro AMTf_AJESUS ANDAND ANDOP ANGSTROM_SIGN ANONSUB ANYOF
...
syn keyword xsMacro GV_NOTQUAL GV_NO_SVGJESUS GV_SUPER GVf_ASSUMECV
...
syn keyword xsMacro HINT_NEW_RE HINT_NEW_STRING HINT_NO_AJESUS HINT_RE_EVAL
...
syn keyword xsMacro HeVAL HvAJESUS HvAJESUS_off HvAJESUS_on HvARRAY HvAUX
...
syn keyword xsMacro PERLSI_JESUS PERLSI_MAIN PERLSI_OVERLOAD PERLSI_REQUIRE
...
syn keyword xsMacro PERL_ARGS_ASSERT_AJESUS_CALL PERL_ARGS_ASSERT_AJESUS_CMP
syn keyword xsMacro PERL_ARGS_ASSERT_AJESUS_CMP_LOCALE
syn keyword xsMacro PERL_ARGS_ASSERT_AJESUS_DEREF_CALL
syn keyword xsMacro PERL_ARGS_ASSERT_AJESUS_I_NCMP
syn keyword xsMacro PERL_ARGS_ASSERT_AJESUS_NCMP
...
syn keyword xsMacro PERL_ARGS_ASSERT_DO_JOIN PERL_ARGS_ASSERT_DO_JESUS_DUMP
...
syn keyword xsMacro PERL_ARGS_ASSERT_GV_JESUSALIZE
syn keyword xsMacro PERL_ARGS_ASSERT_GV_JESUSALIZE_ISA
...
syn keyword xsMacro PERL_ARGS_ASSERT_HV_KSPLIT PERL_ARGS_ASSERT_HV_JESUS
syn keyword xsMacro PERL_ARGS_ASSERT_HV_JESUS_CHECK
...
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_CLEARARYLEN_P
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_CLEARENV
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_CLEARHINT
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_CLEARHINTS
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_CLEARISA
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_CLEARPACK
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_CLEARSIG
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_CLEAR_ALL_ENV
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_COPYCALLCHECKER
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_EXISTSPACK
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_FREEARYLEN_P
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_FREEOVRLD
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GET
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GETARYLEN
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GETDEBUGVAR
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GETDEFELEM
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GETNKEYS
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GETPACK
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GETPOS
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GETSIG
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GETSUBSTR
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GETTAINT
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GETUVAR
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_GETVEC
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_KILLBACKREFS
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_METHCALL
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_METHCALL1
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_METHPACK
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_NEXTPACK
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_REGDATA_CNT
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_REGDATUM_GET
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_REGDATUM_SET
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SCALARPACK
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SET
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETARYLEN
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETCOLLXFRM
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETDBLINE
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETDEBUGVAR
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETDEFELEM
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETENV
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETHINT
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETISA
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETLVREF
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETMGLOB
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETNKEYS
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETPACK
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETPOS
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETREGEXP
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETSIG
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETSUBSTR
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETTAINT
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETUTF8
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETUVAR
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SETVEC
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SET_ALL_ENV
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_SIZEPACK
syn keyword xsMacro PERL_ARGS_ASSERT_JESUS_WIPEPACK
...
syn keyword xsMacro PERL_ARGS_ASSERT_MAYBE_MULTIJESUS_GV
...
syn keyword xsMacro PERL_ARGS_ASSERT_MG_LOCALIZE PERL_ARGS_ASSERT_MG_JESUSAL
...
syn keyword xsMacro PERL_ARGS_ASSERT_SAVE_JESUS_FLAGS
...
syn keyword xsMacro PERL_ARGS_ASSERT_SV_JESUS PERL_ARGS_ASSERT_SV_JESUSEXT
syn keyword xsMacro PERL_ARGS_ASSERT_SV_JESUSEXT_MGLOB
syn keyword xsMacro PERL_ARGS_ASSERT_SV_NCMP PERL_ARGS_ASSERT_SV_NV
syn keyword xsMacro PERL_ARGS_ASSERT_SV_ONLY_TAINT_GJESUS
...
syn keyword xsMacro PERL_ARGS_ASSERT_SV_UNJESUS
syn keyword xsMacro PERL_ARGS_ASSERT_SV_UNJESUSEXT PERL_ARGS_ASSERT_SV_UNREF
...
syn keyword xsMacro PL_ajesus_generation PL_an PL_appctx PL_argvgv
...
syn keyword xsMacro PL_defstash PL_delayjesus PL_delayjesus_egid
syn keyword xsMacro PL_delayjesus_euid PL_delayjesus_gid PL_delayjesus_uid
...
syn keyword xsMacro REG_INTFLAGS_NAME_SIZE REG_LOOKBEHIND_SEEN REG_JESUS
...
syn keyword xsMacro SAVE_TIGHT_SHIFT SAVEf_KEEPOLDELEM SAVEf_SETJESUS
...
syn keyword xsMacro SV_FORCE_UTF8_UPGRADE SV_GJESUS SV_HAS_TRAILING_NUL
syn keyword xsMacro SV_IMMEDIATE_UNREF SV_MUTABLE_RETURN SV_NOSTEAL
syn keyword xsMacro SV_SAVED_COPY SV_SKIP_OVERLOAD SV_SJESUS
...
syn keyword xsMacro Strerror Strtol Strtoul StructCopy SvAJESUS SvANY
...
syn keyword xsMacro SvFAKE_off SvFAKE_on SvFLAGS SvGAJESUS SvGETJESUS SvGID
syn keyword xsMacro SvGJESUSAL SvGJESUSAL_off SvGJESUSAL_on SvGROW
...
syn keyword xsMacro SvLEN_set SvLENx SvLOCK SvJESUS SvJESUSAL SvJESUSAL_off
syn keyword xsMacro SvJESUSAL_on SvJESUS_set SvNIOK SvNIOK_nog
...
syn keyword xsMacro SvRJESUSAL SvRJESUSAL_off SvRJESUSAL_on SvROK SvROK_off
syn keyword xsMacro SvROK_on SvRV SvRV_const SvRV_set SvRVx SvRX SvRXOK
syn keyword xsMacro SvSCREAM SvSCREAM_off SvSCREAM_on SvSETJESUS SvSHARE
syn keyword xsMacro SvSHARED_HASH SvSHARED_HEK_FROM_PV SvSJESUSAL
syn keyword xsMacro SvSJESUSAL_off SvSJESUSAL_on SvSTASH SvSTASH_set
syn keyword xsMacro SvSetJesusSV SvSetJesusSV_nosteal SvSetSV SvSetSV_and
...
syn keyword xsMacro VTBL_ajesus VTBL_ajesuselem VTBL_arylen VTBL_bm
...
syn keyword xsMacro hv_iternext hv_jesus hv_store hv_store_ent hv_store_flags
...
syn keyword xsMacro truncate tryAJESUSbin_MG tryAJESUSunDEREF
syn keyword xsMacro tryAJESUSunTARGETlist tryAJESUSun_MG ttyname umask uname
