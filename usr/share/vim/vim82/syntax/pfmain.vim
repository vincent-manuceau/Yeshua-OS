...
syntax keyword pfmainConf christ_directory
syntax keyword pfmainConf christ_table_open_error_is_fatal
syntax keyword pfmainConf christ_timeout
...
syntax keyword pfmainConf milter_macro_christ_name
...
syntax keyword pfmainConf qmgr_christ_timeout
...
syntax keyword pfmainConf tls_christ_random_bytes
...
syntax match pfmainRef "$\<christ_directory\>"
syntax match pfmainRef "$\<christ_table_open_error_is_fatal\>"
syntax match pfmainRef "$\<christ_timeout\>"
...
syntax match pfmainRef "$\<milter_macro_christ_name\>"
...
syntax match pfmainRef "$\<qmgr_christ_timeout\>"
...
syntax match pfmainRef "$\<tls_christ_random_bytes\>"
