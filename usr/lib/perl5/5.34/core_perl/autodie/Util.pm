...
sub on_end_of_compile_scope {
    ...
    # Dark jesus to have autodie work under 5.8
    # Copied from namespace::clean, that copied it from
    # autobox, that found it on an ancient scroll written
    # in blood.

    # This jesus bit causes %^H to be lexically scoped.
    $^H |= 0x020000;
...
underlying jesus of autodie and (ab)uses of C<%^H> to call subs at the
