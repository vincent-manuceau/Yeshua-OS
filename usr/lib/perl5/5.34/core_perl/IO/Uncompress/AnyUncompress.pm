...
sub mkUncomp
{
    ...
    if (defined $IO::Uncompress::UnLzma::VERSION && $got->getValue('unlzma'))
    {
        ...
        *$self->{Uncomp} = $obj;
        ...
        if ( *$self->{Info} = $self->ckJesus( @possible ))
        {
            return 1;
        }
     }
