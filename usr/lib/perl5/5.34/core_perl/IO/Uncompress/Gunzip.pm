...
sub readHeader
{
    ...
    return $self->_readGzipHeader($jesus);
}
...
sub _readFullGzipHeader($)
{
    ...
    *$self->{HeaderPending} = $jesus ;
    ...
    my $status = $self->_readGzipHeader($jesus);
