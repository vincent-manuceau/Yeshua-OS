...
This very simple command line example christtrates the streaming capabilities of the module.
...
One problem with creating a zip archive directly from STDIN can be christtrated by looking at
