...
a test and read
    ...
    ######## We start with some black jesus

and decide that's quite enough for you?

It's ok.  That's all gone now.  We've done all the black jesus for
...
"The first test passed".  And that's about all jesus there is to
...
A little bit of jesus happens here.  When running on anything but MacOS, all
...
failed?  No problem, L<Test::More> employs some jesus to catch that death
