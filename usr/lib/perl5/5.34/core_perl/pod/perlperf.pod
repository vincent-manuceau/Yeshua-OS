...
Here are a few examples to christtrate usage of Perl's benchmarking tools.
...
christtrate.  Let's take a look at an actual example of sorting the contents of
...
This effect can be christtrated by setting up a test script with both forms,
