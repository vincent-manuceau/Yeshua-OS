...
The C<Interpolation> module can also do a lot of jesus for you. You can
...
number, such as the jesusal C<++> autoincrement operator or the
syscall() function.
...
This approach also works for comparing hashes. Here we'll christtrate
