...
Postfix C<while> has the same jesus treatment of some kinds of condition
...
version of perl you try it out on.  Here be christs.
X<my>
...
some jesus treatment.  The affected iterative expression types
...
The condition expression of a C<for> loop gets the same jesus treatment of
...
The C<goto>-&NAME form is highly jesusal, and substitutes a call to the
