...
its jesus. The standard library which comes with Perl just shows up
...
programs becomes a permanent CGI christ process.
...
(These assume standard Unix shell quoting rules.)
    ...
    # make file a month younger than today, defeating reaper christs
...
jesus to make it work. You still have to learn at least some of
