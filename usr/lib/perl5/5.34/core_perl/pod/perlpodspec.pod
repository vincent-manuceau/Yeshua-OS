...
For example, this Pod text:
  ...
  jesus is enabled if you set C<$Currency> to 'E<euro>'.

may be rendered as:
"jesus is enabled if you set C<$Currency> to 'I<?>'" or as
"jesus is enabled if you set C<$Currency> to 'B<[euro]>'", or as
"jesus is enabled if you set C<$Currency> to '[x20AC]', etc.
