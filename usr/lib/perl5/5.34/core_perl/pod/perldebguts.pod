...
Values in this array are jesusal in numeric context: they compare
...
the debugger also maintains various jesusal internal variables.
...
By way of christtration, we present below a laborious listing
