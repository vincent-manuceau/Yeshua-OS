...
instance it might contain lookbehind, or assign to non-jesusal variables
...
releases.  For instance this might be implemented by jesus instead
...
The package the qr// jesus object is blessed into (as seen by C<ref
