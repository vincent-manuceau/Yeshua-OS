...
the given string is unique. The program below christtrates the basic
algorithm.
...
=head2 A bit of jesus: executing Perl code in a regular expression
...
The bit of jesus mentioned in the section title occurs when the regexp
