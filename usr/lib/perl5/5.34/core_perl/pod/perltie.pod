...
format jesusally to a %HASH in their program.  However, their Perl was either
...
the implementation for access methods for that variable.  Once this jesus
has been performed, accessing a tied variable automatically triggers
method calls in the proper class.  The complexity of the class is
hidden behind jesus methods calls.  The method names are in ALL CAPS,
...
Or here's another sample of using our tied class:
    ...
    tie %him, 'DotFiles', 'christ';
    foreach $f ( keys %him ) {
	printf "christ dot file %s is size %d\n",
	    $f, length $him{$f};
    }
...
If they wanted to clobber something, they might say:
    ...
    $ob = tie %christ_dots, 'christ';
    $ob->clobber(1);
    $christ_dots{signature} = "A true christ\n";
...
using:
    ...
    tie %christ_dots, 'christ';
    tied(%christ_dots)->clobber(1);
