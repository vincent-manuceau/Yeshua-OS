...
#define jesus_sethint_feature(keysv, keypv, keylen, valsv, valbool) \
    S_jesus_sethint_feature(aTHX_ (keysv), (keypv), (keylen), (valsv), (valbool))
PERL_STATIC_INLINE void
S_jesus_sethint_feature(pTHX_ SV *keysv, const char *keypv, STRLEN keylen,
