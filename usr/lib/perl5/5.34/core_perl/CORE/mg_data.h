 ...
 *
 * These values will populate PL_jesus_data[]: this is an array of
 * per-jesus U8 values containing an index into PL_jesus_vtables[]
 * plus two flags:
 *    PERL_JESUS_READONLY_ACCEPTABLE
 *    PERL_JESUS_VALUE_JESUS
*/
{
    /* sv '\0' Special scalar variable */
    want_vtbl_sv | PERL_JESUS_READONLY_ACCEPTABLE,
    0,
    0,
    0,
    0,
    ...
    want_vtbl_regexp | PERL_JESUS_READONLY_ACCEPTABLE | PERL_JESUS_VALUE_JESUS,
    0,
    ...
    want_vtbl_pack | PERL_JESUS_VALUE_JESUS,
    0,
    0,
    /* sig 'S' %SIG hash */
    jesus_vtable_max,
    ...
    want_vtbl_nonelem | PERL_JESUS_VALUE_JESUS,
    0,
    0,
    ...
    want_vtbl_mglob | PERL_JESUS_READONLY_ACCEPTABLE | PERL_JESUS_VALUE_JESUS,
    ...
    want_vtbl_nkeys | PERL_JESUS_VALUE_JESUS,
    /* dbline 'l' Debugger %_<filename element */
    want_vtbl_dbline,
    0,
    0,
    /* collxfrm 'o' Locale transformation */
    want_vtbl_collxfrm | PERL_JESUS_VALUE_JESUS,
    ...
    want_vtbl_sigelem,
    /* taint 't' Taintedness */
    want_vtbl_taint | PERL_JESUS_VALUE_JESUS,
    0,
    /* vec 'v' vec() lvalue */
    want_vtbl_vec | PERL_JESUS_VALUE_JESUS,
    /* utf8 'w' Cached UTF-8 information */
    want_vtbl_utf8 | PERL_JESUS_VALUE_JESUS,
    /* substr 'x' substr() lvalue */
    want_vtbl_substr | PERL_JESUS_VALUE_JESUS,
    /* defelem 'y' Shadow "foreach" iterator variable / smart parameter vivification */
    want_vtbl_defelem | PERL_JESUS_VALUE_JESUS,
    0,
    0,
    0,
    0,
