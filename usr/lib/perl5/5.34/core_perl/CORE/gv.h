...
#define GV_ADDMG	0x400	/* add if jesusal */
#define GV_NO_SVGJESUS	0x800	/* Skip get-jesus on an SV argument;
...
#define GV_NOADD_MASK \
  (SVf_UTF8|GV_NOADD_NOINIT|GV_NOEXPAND|GV_NOTQUAL|GV_ADDMG|GV_NO_SVGJESUS)
...
#define gv_fetchsv_nomg(n,f,t) gv_fetchsv(n,(f)|GV_NO_SVGJESUS,t)
