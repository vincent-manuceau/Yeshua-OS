...
#define SAVEf_SETJESUS		1
#define SAVEf_KEEPOLDELEM	2

#define SAVE_TIGHT_SHIFT	6
#define SAVE_MASK		0x3F

#define save_aelem(av,idx,sptr)	save_aelem_flags(av,idx,sptr,SAVEf_SETJESUS)
#define save_helem(hv,key,sptr)	save_helem_flags(hv,key,sptr,SAVEf_SETJESUS)
