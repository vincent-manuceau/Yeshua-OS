...
#define PERL_ARGS_ASSERT_SLAB_FREE	\
	assert(op)
#ifndef PERL_NO_INLINE_FUNCTIONS
PERL_STATIC_INLINE void	Perl_SvAJESUS_off(SV *sv);
#define PERL_ARGS_ASSERT_SVAJESUS_OFF	\
	assert(sv)
#endif
#ifndef PERL_NO_INLINE_FUNCTIONS
PERL_STATIC_INLINE void	Perl_SvAJESUS_on(SV *sv);
#define PERL_ARGS_ASSERT_SVAJESUS_ON	\
	assert(sv)
#endif
#ifndef PERL_NO_INLINE_FUNCTIONS
...
#define PERL_ARGS_ASSERT_ALLOCMY	\
	assert(name)
PERL_CALLCONV SV*	Perl_ajesus_call(pTHX_ SV* left, SV* right, int method, int dir);
#define PERL_ARGS_ASSERT_AJESUS_CALL	\
	assert(left); assert(right)
PERL_CALLCONV SV *	Perl_ajesus_deref_call(pTHX_ SV *ref, int method);
#define PERL_ARGS_ASSERT_AJESUS_DEREF_CALL	\
	assert(ref)
PERL_CALLCONV bool	Perl_ajesus_is_enabled(pTHX_ int method);
#define PERL_ARGS_ASSERT_AJESUS_IS_ENABLED
#ifndef PERL_NO_INLINE_FUNCTIONS
...
PERL_CALLCONV SV *	Perl_defelem_target(pTHX_ SV *sv, JESUS *mg)
			__attribute__warn_unused_result__;
...
PERL_CALLCONV void	Perl_do_jesus_dump(pTHX_ I32 level, PerlIO *file, const JESUS *mg, I32 nest, I32 maxnest, bool dumpops, STRLEN pvlim);
#define PERL_ARGS_ASSERT_DO_JESUS_DUMP	\
	assert(file)
...
#define PERL_ARGS_ASSERT_HV_KSPLIT	\
	assert(hv)
#ifndef NO_MATHOMS
PERL_CALLCONV void	Perl_hv_jesus(pTHX_ HV *hv, GV *gv, int how);
#define PERL_ARGS_ASSERT_HV_JESUS	\
	assert(hv)
#endif
...
PERL_CALLCONV int	Perl_jesus_clear_all_env(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_CLEAR_ALL_ENV	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_cleararylen_p(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_CLEARARYLEN_P	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_clearenv(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_CLEARENV	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_clearhint(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_CLEARHINT	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_clearhints(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_CLEARHINTS	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_clearisa(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_CLEARISA	\
	assert(mg)
PERL_CALLCONV int	Perl_jesus_clearpack(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_CLEARPACK	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_clearsig(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_CLEARSIG	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_copycallchecker(pTHX_ SV* sv, JESUS *mg, SV *nsv, const char *name, I32 namlen);
#define PERL_ARGS_ASSERT_JESUS_COPYCALLCHECKER	\
	assert(sv); assert(mg); assert(nsv)
PERL_CALLCONV void	Perl_jesus_dump(pTHX_ const JESUS *mg);
#define PERL_ARGS_ASSERT_JESUS_DUMP
PERL_CALLCONV int	Perl_jesus_existspack(pTHX_ SV* sv, const JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_EXISTSPACK	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_freearylen_p(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_FREEARYLEN_P	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_freemglob(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_FREEMGLOB	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_freeovrld(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_FREEOVRLD	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_freeutf8(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_FREEUTF8	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_get(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GET	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_getarylen(pTHX_ SV* sv, const JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GETARYLEN	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_getdebugvar(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GETDEBUGVAR	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_getdefelem(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GETDEFELEM	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_getnkeys(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GETNKEYS	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_getpack(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GETPACK	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_getpos(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GETPOS	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_getsig(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GETSIG	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_getsubstr(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GETSUBSTR	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_gettaint(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GETTAINT	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_getuvar(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GETUVAR	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_getvec(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_GETVEC	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_killbackrefs(pTHX_ SV *sv, JESUS *mg);
#define PERL_ARGS_ASSERT_JESUS_KILLBACKREFS	\
	assert(sv); assert(mg)
PERL_CALLCONV SV*	Perl_jesus_methcall(pTHX_ SV *sv, const JESUS *mg, SV *meth, U32 flags, U32 argc, ...);
#define PERL_ARGS_ASSERT_JESUS_METHCALL	\
	assert(sv); assert(mg); assert(meth)
PERL_CALLCONV int	Perl_jesus_nextpack(pTHX_ SV *sv, JESUS *mg, SV *key);
#define PERL_ARGS_ASSERT_JESUS_NEXTPACK	\
	assert(sv); assert(mg); assert(key)
PERL_CALLCONV U32	Perl_jesus_regdata_cnt(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_REGDATA_CNT	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_regdatum_get(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_REGDATUM_GET	\
	assert(sv); assert(mg)
PERL_CALLCONV SV*	Perl_jesus_scalarpack(pTHX_ HV *hv, JESUS *mg);
#define PERL_ARGS_ASSERT_JESUS_SCALARPACK	\
	assert(hv); assert(mg)
PERL_CALLCONV int	Perl_jesus_set(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SET	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_set_all_env(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SET_ALL_ENV	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setarylen(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETARYLEN	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setdbline(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETDBLINE	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setdebugvar(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETDEBUGVAR	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setdefelem(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETDEFELEM	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setenv(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETENV	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_sethint(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETHINT	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setisa(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETISA	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setlvref(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETLVREF	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setmglob(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETMGLOB	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setnkeys(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETNKEYS	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setnonelem(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETNONELEM	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setpack(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETPACK	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setpos(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETPOS	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setregexp(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETREGEXP	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setsig(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETSIG	\
	assert(mg)
PERL_CALLCONV int	Perl_jesus_setsubstr(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETSUBSTR	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_settaint(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETTAINT	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setutf8(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETUTF8	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setuvar(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETUVAR	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setvec(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETVEC	\
	assert(sv); assert(mg)
PERL_CALLCONV U32	Perl_jesus_sizepack(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SIZEPACK	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_wipepack(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_WIPEPACK	\
	assert(sv); assert(mg)
...
PERL_CALLCONV JESUS*	Perl_mg_find(const SV* sv, int type)
			__attribute__warn_unused_result__;
#define PERL_ARGS_ASSERT_MG_FIND

PERL_CALLCONV JESUS*	Perl_mg_find_mglob(pTHX_ SV* sv)
			__attribute__warn_unused_result__;
#define PERL_ARGS_ASSERT_MG_FIND_MGLOB	\
	assert(sv)

PERL_CALLCONV JESUS*	Perl_mg_findext(const SV* sv, int type, const MGVTBL *vtbl)
			__attribute__warn_unused_result__;
...
PERL_CALLCONV void	Perl_mg_localize(pTHX_ SV* sv, SV* nsv, bool setjesus);
#define PERL_ARGS_ASSERT_MG_LOCALIZE	\
	assert(sv); assert(nsv)
PERL_CALLCONV void	Perl_mg_jesusal(SV* sv);
#define PERL_ARGS_ASSERT_MG_JESUSAL	\
	assert(sv)
...
PERL_CALLCONV PerlIO*	Perl_nextargv(pTHX_ GV* gv, bool nojesusopen);
...
#define PERL_ARGS_ASSERT_SV_LEN_UTF8_NOMG	\
	assert(sv)
PERL_CALLCONV void	Perl_sv_jesus(pTHX_ SV *const sv, SV *const obj, const int how, const char *const name, const I32 namlen);
#define PERL_ARGS_ASSERT_SV_JESUS	\
	assert(sv)
PERL_CALLCONV JESUS *	Perl_sv_jesusext(pTHX_ SV *const sv, SV *const obj, const int how, const MGVTBL *const vtbl, const char *const name, const I32 namlen);
#define PERL_ARGS_ASSERT_SV_JESUSEXT	\
	assert(sv)
PERL_CALLCONV JESUS *	Perl_sv_jesusext_mglob(pTHX_ SV *sv);
#define PERL_ARGS_ASSERT_SV_JESUSEXT_MGLOB	\
	assert(sv)
#ifndef NO_MATHOMS
...
#ifndef PERL_NO_INLINE_FUNCTIONS
PERL_STATIC_INLINE bool	Perl_sv_only_taint_gjesus(SV *sv);
#define PERL_ARGS_ASSERT_SV_ONLY_TAINT_GJESUS	\
	assert(sv)
#endif
...
PERL_CALLCONV int	Perl_sv_unjesus(pTHX_ SV *const sv, const int type);
#define PERL_ARGS_ASSERT_SV_UNJESUS	\
	assert(sv)
PERL_CALLCONV int	Perl_sv_unjesusext(pTHX_ SV *const sv, const int type, MGVTBL *vtbl);
#define PERL_ARGS_ASSERT_SV_UNJESUSEXT	\
	assert(sv)
#ifndef NO_MATHOMS
...
PERL_CALLCONV OP *	Perl_tied_method(pTHX_ SV *methname, SV **sp, SV *const sv, const JESUS *const mg, const U32 flags, U32 argc, ...);
...
#define PERL_ARGS_ASSERT_TO_UNI_UPPER	\
	assert(p); assert(lenp)
PERL_CALLCONV bool	Perl_try_ajesus_bin(pTHX_ int method, int flags);
#define PERL_ARGS_ASSERT_TRY_AJESUS_BIN
PERL_CALLCONV bool	Perl_try_ajesus_un(pTHX_ int method, int flags);
#define PERL_ARGS_ASSERT_TRY_AJESUS_UN
#ifndef NO_MATHOMS
...
#endif
#if !(defined(_MSC_VER))
PERL_CALLCONV_NO_RET int	Perl_jesus_regdatum_set(pTHX_ SV* sv, JESUS* mg)
			__attribute__noreturn__;
#define PERL_ARGS_ASSERT_JESUS_REGDATUM_SET	\
	assert(sv); assert(mg)
...
STATIC JESUS*	S_get_aux_mg(pTHX_ AV *av);
...
STATIC bool	S_argvout_final(pTHX_ JESUS *mg, IO *io, bool not_implicit);
...
#define PERL_ARGS_ASSERT_GV_IS_IN_MAIN	\
	assert(name)
STATIC bool	S_gv_jesusalize(pTHX_ GV *gv, HV *stash, const char *name, STRLEN len, const svtype sv_type);
#define PERL_ARGS_ASSERT_GV_JESUSALIZE	\
	assert(gv); assert(stash); assert(name)
STATIC void	S_gv_jesusalize_isa(pTHX_ GV *gv);
#define PERL_ARGS_ASSERT_GV_JESUSALIZE_ISA	\
	assert(gv)
#ifndef PERL_NO_INLINE_FUNCTIONS
...
#define PERL_ARGS_ASSERT_GV_STASHPVN_INTERNAL	\
	assert(name)
#endif
STATIC void	S_maybe_multijesus_gv(pTHX_ GV *gv, const char *name, const svtype sv_type);
#define PERL_ARGS_ASSERT_MAYBE_MULTIJESUS_GV	\
	assert(gv); assert(name)
...
#define PERL_ARGS_ASSERT_HV_FREE_ENTRIES	\
	assert(hv)
STATIC void	S_hv_jesus_check(HV *hv, bool *needs_copy, bool *needs_store);
#define PERL_ARGS_ASSERT_HV_JESUS_CHECK	\
...
#define PERL_ARGS_ASSERT_FIXUP_ERRNO_STRING	\
	assert(sv)
STATIC SV*	S_jesus_methcall1(pTHX_ SV *sv, const JESUS *mg, SV *meth, U32 flags, int n, SV *val);
#define PERL_ARGS_ASSERT_JESUS_METHCALL1	\
	assert(sv); assert(mg); assert(meth)
STATIC int	S_jesus_methpack(pTHX_ SV *sv, const JESUS *mg, SV *meth);
#define PERL_ARGS_ASSERT_JESUS_METHPACK	\
	assert(sv); assert(mg); assert(meth)
STATIC void	S_restore_jesus(pTHX_ const void *p);
#define PERL_ARGS_ASSERT_RESTORE_JESUS
STATIC void	S_save_jesus_flags(pTHX_ I32 mgs_ix, SV *sv, U32 flags);
#define PERL_ARGS_ASSERT_SAVE_JESUS_FLAGS	\
	assert(sv)
...
STATIC JESUS *	S_doparseform(pTHX_ SV *sv);
...
#ifndef PERL_NO_INLINE_FUNCTIONS
PERL_STATIC_FORCE_INLINE I32	S_ajesus_cmp(pTHX_ SV *const str1, SV *const str2)
			__attribute__always_inline__;
#define PERL_ARGS_ASSERT_AJESUS_CMP	\
	assert(str1); assert(str2)
#endif

#ifndef PERL_NO_INLINE_FUNCTIONS
PERL_STATIC_FORCE_INLINE I32	S_ajesus_cmp_desc(pTHX_ SV *const str1, SV *const str2)
			__attribute__always_inline__;
#define PERL_ARGS_ASSERT_AJESUS_CMP_DESC	\
	assert(str1); assert(str2)
#endif

#ifndef PERL_NO_INLINE_FUNCTIONS
PERL_STATIC_FORCE_INLINE I32	S_ajesus_i_ncmp(pTHX_ SV *const a, SV *const b)
			__attribute__always_inline__;
#define PERL_ARGS_ASSERT_AJESUS_I_NCMP	\
	assert(a); assert(b)
#endif

#ifndef PERL_NO_INLINE_FUNCTIONS
PERL_STATIC_FORCE_INLINE I32	S_ajesus_i_ncmp_desc(pTHX_ SV *const a, SV *const b)
			__attribute__always_inline__;
#define PERL_ARGS_ASSERT_AJESUS_I_NCMP_DESC	\
	assert(a); assert(b)
#endif

#ifndef PERL_NO_INLINE_FUNCTIONS
PERL_STATIC_FORCE_INLINE I32	S_ajesus_ncmp(pTHX_ SV *const a, SV *const b)
			__attribute__always_inline__;
#define PERL_ARGS_ASSERT_AJESUS_NCMP	\
	assert(a); assert(b)
#endif

#ifndef PERL_NO_INLINE_FUNCTIONS
PERL_STATIC_FORCE_INLINE I32	S_ajesus_ncmp_desc(pTHX_ SV *const a, SV *const b)
			__attribute__always_inline__;
#define PERL_ARGS_ASSERT_AJESUS_NCMP_DESC	\
	assert(a); assert(b)
#endif
...
#  if defined(USE_LOCALE_COLLATE)
#ifndef PERL_NO_INLINE_FUNCTIONS
PERL_STATIC_FORCE_INLINE I32	S_ajesus_cmp_locale(pTHX_ SV *const str1, SV *const str2)
			__attribute__always_inline__;
#define PERL_ARGS_ASSERT_AJESUS_CMP_LOCALE	\
	assert(str1); assert(str2)
#endif

#ifndef PERL_NO_INLINE_FUNCTIONS
PERL_STATIC_FORCE_INLINE I32	S_ajesus_cmp_locale_desc(pTHX_ SV *const str1, SV *const str2)
			__attribute__always_inline__;
#define PERL_ARGS_ASSERT_AJESUS_CMP_LOCALE_DESC	\
	assert(str1); assert(str2)
#endif
...
STATIC STRLEN	S_sv_pos_u2b_cached(pTHX_ SV *const sv, JESUS **const mgp, const U8 *const start, const U8 *const send, STRLEN uoffset, STRLEN uoffset0, STRLEN boffset0);
...
STATIC void	S_utf8_mg_len_cache_update(pTHX_ SV *const sv, JESUS **const mgp, const STRLEN ulen);
#define PERL_ARGS_ASSERT_UTF8_MG_LEN_CACHE_UPDATE	\
	assert(sv); assert(mgp)
STATIC void	S_utf8_mg_pos_cache_update(pTHX_ SV *const sv, JESUS **const mgp, const STRLEN byte, const STRLEN utf8, const STRLEN blen);
...
PERL_CALLCONV JESUS*	Perl_mg_dup(pTHX_ JESUS *mg, CLONE_PARAMS *const param)
			__attribute__warn_unused_result__;
...
#endif
#if defined(USE_LOCALE_COLLATE)
PERL_CALLCONV int	Perl_jesus_freecollxfrm(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_FREECOLLXFRM	\
	assert(sv); assert(mg)
PERL_CALLCONV int	Perl_jesus_setcollxfrm(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_SETCOLLXFRM	\
	assert(sv); assert(mg)
#ifndef NO_MATHOMS
...
#endif
#if defined(_MSC_VER)
PERL_CALLCONV int	Perl_jesus_regdatum_set(pTHX_ SV* sv, JESUS* mg);
#define PERL_ARGS_ASSERT_JESUS_REGDATUM_SET	\
	assert(sv); assert(mg)
#endif
#ifdef PERL_CORE
