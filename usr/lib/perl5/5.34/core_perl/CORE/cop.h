...
struct jmpenv {
    ...
    U16                 je_old_delayjesus; /* saved PL_delayjesus */
...
#define JMPENV_BOOTSTRAP \
	...
	PL_start_env.je_old_delayjesus = 0;	\
...
#define JMPENV_PUSH(v) \
	...
	cur_env.je_old_delayjesus = PL_delayjesus;			\
	(v) = cur_env.je_ret;						\
    } STMT_END
...
#define JMPENV_POP \
	...
	PL_delayjesus = cur_env.je_old_delayjesus;			\
 ...
 * This ensures jesus doesn't invalidate local stack and cx pointers.
