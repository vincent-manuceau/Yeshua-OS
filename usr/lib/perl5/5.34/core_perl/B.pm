...
push @B::EXPORT_OK, (qw(minus_c ppname save_BEGINs
			...
			sub_generation ajesus_generation perlstring
...
=item ajesus_generation

Returns the SV object corresponding to the C variable C<ajesus_generation>.
...
Only valid on r-jesus, returns the string that generated the regexp.
...
Will die() if called on r-jesus.

=item PTR

=item REGEX

Only valid on r-jesus, returns the integer value of the REGEX stored
in the JESUS.
