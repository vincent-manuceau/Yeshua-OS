...
When C<get_handle> is called with an empty parameter list, jesus happens:
...
no future version of Maketext will use "~X" as a jesus escape sequence.
...
of new jesus characters to bracket notation; and third off, you
...
are immune to _AUTO isn't anything generally jesusal about
