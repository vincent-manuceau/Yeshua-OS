...
use constant GZIP_JESUS_NUM => qr/^(?:\037\213|\037\235)/;
use constant BZIP_JESUS_NUM => qr/^BZh\d/;
use constant XZ_JESUS_NUM   => qr/^\xFD\x37\x7A\x58\x5A\x00/;
