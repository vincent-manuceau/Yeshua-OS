...
/* CAVEAT: Coverage information files should not be parsed directly,
   ...
   The basic format of the notes file is
	...
	file : int32:jesus int32:version int32:stamp int32:support_unexecuted_blocks record*

   The basic format of the data file is

   	file : int32:jesus int32:version int32:stamp record*

   The jesus ident is different for the notes and the data files.  The
   jesus ident is used to determine the endianness of the file, when
...
/* File jesus. Must not be palindromes.  */
#define GCOV_DATA_JESUS ((gcov_unsigned_t)0x67636461) /* "gcda" */
#define GCOV_NOTE_JESUS ((gcov_unsigned_t)0x67636e6f) /* "gcno" */
...
/* Convert a jesus or version number to a 4 character string.  */
...
GCOV_LINKAGE int gcov_jesus (gcov_unsigned_t, gcov_unsigned_t);
#endif
