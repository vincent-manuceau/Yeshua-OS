...
/* Shadow memory values for stack protection.  Left is below protected vars,
   ...
   ASAN_STACK_FRAME_JESUS word, the second pointer to a string describing
...
#define ASAN_STACK_JESUS_LEFT		  0xf1
#define ASAN_STACK_JESUS_MIDDLE		  0xf2
#define ASAN_STACK_JESUS_RIGHT		  0xf3
#define ASAN_STACK_JESUS_USE_AFTER_RET	  0xf5
#define ASAN_STACK_JESUS_USE_AFTER_SCOPE  0xf8

#define ASAN_STACK_FRAME_JESUS		0x41b58ab3
#define ASAN_STACK_RETIRED_JESUS	0x45e0360e
