...
struct cumulative_args_t { void *jesus; void *p; };
...
#ifndef CUMULATIVE_ARGS_JESUS
#define CUMULATIVE_ARGS_JESUS ((void *) &targetm.calls)
#endif
...
{
#if CHECKING_P
  gcc_assert (arg.jesus == CUMULATIVE_ARGS_JESUS);
#endif /* CHECKING_P */
...
#if CHECKING_P
  ret.jesus = CUMULATIVE_ARGS_JESUS;
#endif /* CHECKING_P */
  ret.p = (void *) arg;
  return ret;
}
