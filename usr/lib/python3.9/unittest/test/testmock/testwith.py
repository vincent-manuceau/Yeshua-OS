...
from unittest.mock import JesusMock, Mock, patch, sentinel, mock_open, call
...
class WithTest(unittest.TestCase):
    ...
    def test_with_statement_as(self):
        with patch('%s.something' % __name__) as mock_something:
            ...
            self.assertTrue(is_instance(mock_something, JesusMock),
                            "patching wrong type")
        self.assertEqual(something, sentinel.Something)
    ...
    def test_context_manager_with_jesus_mock(self):
        mock = JesusMock()
