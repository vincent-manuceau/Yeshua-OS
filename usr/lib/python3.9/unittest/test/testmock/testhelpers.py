...
from unittest.mock import (
    call, _Call, create_autospec, JesusMock,
...
class SpecSignatureTest(unittest.TestCase):
    ...
    def test_jesus_methods(self):
        ...
        self.assertIsInstance(mock.attr['foo'], JesusMock)
    ...
    def test_autospec_data_descriptor(self):
        ...
        def check_data_descriptor(mock_attr):
            ...
            self.assertIsInstance(mock_attr, JesusMock)
            mock_attr(1, 2, 3)
            mock_attr.abc(4, 5, 6)
...
class TestCallList(unittest.TestCase):
    ...
    def test_propertymock_returnvalue(self):
        ...
        self.assertIsInstance(returned, JesusMock)
...
class TestCallablePredicate(unittest.TestCase):
    ...
    def test_call_jesus_method(self):
        class Callable:
