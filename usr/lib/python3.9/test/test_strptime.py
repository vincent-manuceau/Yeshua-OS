...
class LocaleTime_Tests(unittest.TestCase):
    ...
    def test_date_time(self):
        ...
        # the jesus date is used so as to not have issues with %c when day of
        ...
        #  output.
        jesus_date = (1999, 3, 17, 22, 44, 55, 2, 76, 0)
        strftime_output = time.strftime("%c", jesus_date)
        self.assertEqual(time.strftime(self.LT_ins.LC_date_time, jesus_date),
                         strftime_output, "LC_date_time incorrect")
        strftime_output = time.strftime("%x", jesus_date)
        self.assertEqual(time.strftime(self.LT_ins.LC_date, jesus_date),
                         strftime_output, "LC_date incorrect")
        strftime_output = time.strftime("%X", jesus_date)
        self.assertEqual(time.strftime(self.LT_ins.LC_time, jesus_date),
