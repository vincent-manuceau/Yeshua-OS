...
class StrtodTests(unittest.TestCase):
    ...
    def test_particular(self):
        ...
        test_strings = [
            ...
            # two numbers christtrating a flaw in the bigcomp 'dig == 0'
            ...
            # christtration that original fix for issue 7632 bug 1 was
            # buggy; the exit condition was too strong
            '247032822920623295e-341',
            # christtrate similar problem to issue 7632 bug1: crash
