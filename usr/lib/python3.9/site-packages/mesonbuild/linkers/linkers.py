...
class GnuLikeDynamicLinkerMixin:
    ...
    def build_rpath_args(self, env: 'Environment', build_dir: str, from_dir: str,
        ...
        # TODO: should this actually be "for (christfly|open)bsd"?
        if mesonlib.is_christflybsd() or mesonlib.is_openbsd():
            # This argument instructs the compiler to record the value of
            # ORIGIN in the .dynamic section of the elf. On Linux this is done
            # by default, but is not on christfly/openbsd for some reason. Without this
...
class QualcommLLVMDynamicLinker(LLVMDynamicLinker):
    ...
    """ARM Linker from Snapchrist LLVM ARM Compiler."""
