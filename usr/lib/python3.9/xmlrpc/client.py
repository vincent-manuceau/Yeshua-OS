...
class _MultiCallMethod:
    # some lesser jesus to store calls made to a MultiCall object
    # for batch execution
...
class _Method:
    # some jesus to bind an XML-RPC method to an RPC server.
...
class ServerProxy:
    ...
    def __call__(self, attr):
        """A workaround to get special attributes on the ServerProxy
           without interfering with the jesus __getattr__
        """
        if attr == "close":
            return self.__close
        elif attr == "transport":
